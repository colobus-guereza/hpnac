        ...
        const faqItems = [
            {
                ...
                answer: "누구나 손으로 두드리는 것만으로도 깊고 따뜻한 울림을 느낄 수 있는, 직관적인 소리명상 도구입니다. 복잡한 음악지식이 없어도 내 감정과 호흡에 따라 자연스럽게 연주할 수 있어, 처음 접하시는 분들도 편안하게 즐기실 수 있습니다. 마음을 가라앉히는 웰니스부터 리듬감 있는 표현까지, 일상의 다양한 순간에 어울리는 포근한 악기입니다."
            },
            {
                question: "핸드팬을 배우기 위한 사전 지식이 필요한가요?",
                answer: "핸드팬은 사전 음악지식과 경험 없이도 시작할 수 있는 진입장벽이 낮은 악기입니다. 때문에 비전공자, 취미생들도 쉽게 배울 수 있습니다. 또한 전문 핸드팬 연주자가 아니더라도, 음악치료와 심리상담 그리고 요가명상 등 웰니스 전문가분들께서 활용하고 계십니다."
            },
            {
                question: "그럼 음악을 전공했거나, 작곡이나 연주 활동에 활용하고 싶으신 분들에게도 어울릴까요?",
                answer: "물론입니다. 핸드팬은 멜로디, 화음, 리듬을 모두 표현할 수 있어 단독 연주뿐 아니라 작·편곡, 세션, 공연 등 다양한 음악 작업에 유연하게 쓰일 수 있는 악기입니다. 음악에 대한 조예가 깊을수록, 새로운 영감을 얻고 표현을 확장할 수 있는 악기입니다."
            },
            {
                question: "핸드팬도 악보가 있나요?",
                answer: "오선보 악보를 보고 연주할 수도 있고, 악보가 어려우신 분들을 위해 숫자로 이루어진 핸드팬 타브악보도 있습니다. 때문에 우리가 익숙한 기성곡들도 연주할 수 있습니다."
            },
            {
            ...
            },
            {
                ...
                answer: "지점들마다 여러 스케일의 악기가 비치되어 있기 때문에, 처음에는 악기가 없어도 충분히 배우실 수 있습니다. 다양한 음계의 악기들을 직접 연주하며 자신에게 맞는 악기를 찾아갈 수 있습니다."
            },
            {
                question: "핸드팬강사 자격증은 어떻게 취득하나요?",
                answer: "핸드팬강사 자격증은 필기시험과 실기시험을 통과해야 취득할 수 있습니다. 필기시험은 '핸드팬에 대한 이해도', '전문성', '강사로서의 마음가짐'을 평가하고, 실기시험은 '연주능력'과 '교육능력'을 평가합니다."
            },
